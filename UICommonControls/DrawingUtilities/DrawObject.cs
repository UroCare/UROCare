...
namespace SHC.UROCare.UICommonControls
{
    ...
    public abstract class DrawObject
    {
        ...
        private const string _entryColor = "Color";
        private const string _entryPenWidth = "PenWidth";
        ...
        /// <summary>
        ///   Normalize object. Call this function in the end of object resizing.
        /// </summary>
        ...
        public virtual void SaveToStream(SerializationInfo info, int orderNumber)
        {
            info.AddValue(
                String.Format(CultureInfo.InvariantCulture,
                              "{0}{1}",
                              _entryColor, orderNumber),
                Color.ToArgb());

            info.AddValue(
                String.Format(CultureInfo.InvariantCulture,
                              "{0}{1}",
                              _entryPenWidth, orderNumber),
                PenWidth);
        }
        ...
        /// <summary>
        ///   Copy fields from this instance to cloned instance drawObject. Called from Clone functions of derived classes.
        /// </summary>
