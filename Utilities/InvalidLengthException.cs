...
{
    /// <summary>
    ///   Exception to be thrown on invalid length of given string.
    /// </summary>
    ...
    public class TooLongStringException : Exception
    {
        ...
        public TooLongStringException(string message, Exception innerException) : base(message, innerException)
        {
        }
        ...
        ///   is zero (0).</exception>
        protected TooLongStringException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}